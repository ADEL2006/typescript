...
export default function HigherOrderRadioInputTest() {
    ...
    const radioInputs = useMemo(() => jobTitles.map((value, index) => (
        <label key={index} className="flex justify-start curosr-pointer label">
            <input type="radio" name="higher jobs" className="mr-4 radio radio-primary" checked={index === selectedIndex} onChange={onChange(index)} />
        </label>
    ...
    return (
        <section className="mt-4">
            ...
            <div className="flex flex-col justify-center mt-4">
                <Subtitle>What is yuor job?</Subtitle>
